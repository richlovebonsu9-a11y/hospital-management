...
<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm bg-white py-3">
    <div class="container">
        <a class="navbar-brand fw-800 d-flex align-items-center" href="/" style="letter-spacing: -0.5px;">
            <img src="/assets/img/logo.png" alt="KM Logo" style="width: 38px; height: 38px; object-fit: contain;" class="me-2 rounded-3 shadow-sm">
            <span class="text-dark">Kobby Moore <span class="text-primary">Hospital</span></span>
        </a>
