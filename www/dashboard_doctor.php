...
<body>
    <div class="sidebar p-4">
        ...
        <nav>
            <a href="#" class="nav-link-custom active"><i class="bi bi-people-fill"></i> Patient Queue</a>
            <a href="#" class="nav-link-custom"><i class="bi bi-calendar-event"></i> My Schedule</a>
            <a href="#" class="nav-link-custom"><i class="bi bi-file-earmark-medical-fill"></i> Consultations</a>
            <a href="#" class="nav-link-custom"><i class="bi bi-capsule"></i> E-Prescriptions</a>
            <a href="#" class="nav-link-custom"><i class="bi bi-clipboard-pulse"></i> Lab Results</a>
            <hr class="my-4">
